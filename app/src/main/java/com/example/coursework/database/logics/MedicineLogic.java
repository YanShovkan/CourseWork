...
public class MedicineLogic {
    ...
    final String COLUMN_PRICE = "price_per_pakage";
    ...
    public List<MedicineModel> getFullList() {
        ...
        do {
            ...
            obj.setPrice_per_pakage(cursor.getInt((int) cursor.getColumnIndex(COLUMN_PRICE)));
    ...
    public void insert(MedicineModel model) {
        ...
        content.put(COLUMN_PRICE,model.getPrice_per_pakage());
